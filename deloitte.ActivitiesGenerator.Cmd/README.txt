...
NB: The Unit tests require the MSTest package. Packages were not included to save space in the zip file.
This can be download via Visual Studios NuGet Package Manager.
...
If private method warrant unit tests due to their complexity, the implication is that they should be drawn out in
to their own separate interface based class.
